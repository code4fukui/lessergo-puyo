class Score {
    ...
    static initialize() {
        ...
        Score.scoreElement.style.width = Config.puyoImageWidth * Config.stageCols +(-60)+ 'px';
        ...
        Score.digitCount = Math.trunc(Config.stageCols * Config.puyoImageWidth / GameImage.getDigitImageWidth()-5);
        Score.score = 0;
