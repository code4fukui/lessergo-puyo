export class Config {
    ...
    static stageCols = 8; // ステージの横の個数
    static stageRows = 11; // ステージの縦の個数
    ...
    static puyoColorMax = 4; // 何色のぷよを使うか
    static fallingSpeed = 2; // 自由落下のスピード
    ...
    static playerFallingSpeed = 0.2; // プレイ中の自然落下のスピード
    static playerLockDelayFrames = 20; // 何フレーム接地したらぷよを固定するか
    static playerDownSpeed = 30; // プレイ中の下キー押下時の落下スピード
