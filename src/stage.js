class Stage {
    ...
    static initialize() {
        ...
        Stage.nextElement.style.left = (Config.puyoImageWidth * (Config.stageCols - 1.5))  - borderWidth + 'px';
        ...
        Stage.nextElement.style.borderRadius = Config.puyoImageWidth * 0.1 + "px";
        Stage.nextElement.style.backgroundColor = "rgba(0, 0, 0, 0.5 )";
        nextContainerElement.appendChild(Stage.nextElement);

        // logo画像を用意する
        Stage.logoImage = document.getElementById("logo");
        Stage.logoImage.width = Config.puyoImageWidth * Config.stageCols*0.75;
        Stage.logoImage.style.position = 'absolute';
        Stage.logoImage.style.left = (-250)+ 'px';
        Stage.logoImage.style.top = (10) + 'px';
        Stage.logoImage.style.opacity = '1';
        Stage.nextElement.appendChild(Stage.logoImage);
